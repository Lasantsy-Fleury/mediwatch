...
class TreatmentHypothesis(BaseModel):
    ...
    Le médecin décrit le changement envisagé.
    """
    patient_id: str
...
class SimulationResult(BaseModel):
    ...
    decompensation_day: Optional[int] = Field(None, description="Jour estimé de décompensation si risque > 0.7")
    narrative: str = Field(..., description="Explication en langage naturel de la simulation")
